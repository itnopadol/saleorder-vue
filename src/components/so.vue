      ...
      <div class="Wcontainer">
    	<div class="head-r">
    		<div class="headR-l">
    			มูลค่าสุทธิ
	      		<br>
	      		<i class="material-icons" width>monetization_on</i>
    		</div>
    		<div class="headR-r">
    			{{ totalNetAmount }} ฿
    		</div>   
    	...
    	<div class="head-l1">
    		...
    		<div class="headL-r1">
    			<input type="text" style="background-color: #ffe6ff;" class="input" placeholder="เลขที่เอกสาร ..." :value="docNo" readonly>
    		</div>
    		<div class="headL-l1">
    			รหัสลูกค้า :
    		</div>
    		<div class="headL-r1">
				<input type="text" class="input" style="width:75%; background-color: #ffe6ff;" placeholder="รหัสลูกค้า" v-model="arCode" readonly>
				<i class="material-icons" aria-hidden="true" @click="searchCustomer" :disabled="detail_itemlists.length!=0">search</i>
    		</div>
    	</div>
    	<div class="head-l1">
    		<div class="headL-l1">
    		...
    		<div class="headL-r1">
	    		<datepicker format="dd/MM/yyyy" style = "position: static;" input-class="input date" v-model="docDate" required language="th" calendar-button-icon="fa fa-calendar" calendar-button :disabled="nowDate" :disabled-picker="disabled"></datepicker>
    		</div>
    		<div class="headL-l1">
    			ประเภทขนส่ง :
    		</div>
    	...
    	<hr style="clear: both; margin: 5px 0 0 0;" />
		<div class="body-c">
			<div class="web-view">
				<table class="tableSection">
					<thead>
						<tr>
                            ...
                            <th style="width: 140px; text-align: left;">รหัสสินค้า</th>
                            <th style="width: 400px; text-align: left;">ชื่อสินค้า</th>
                            <th style="width: 100px; text-align: left;">คลัง/ชั้นเก็บ</th>
                            <th style="width: 100px; text-align: center;">หน่วยนับ</th>
                            <th style="width: 120px; text-align: right;" class="text">จำนวน</th>
                            <th style="width: 140px; text-align: right;" class="text">ราคา/หน่วย</th>
                            <th style="width: 110px; text-align: right;" class="text">ส่วนลด % ,บาท</th>
                            <th style="width: 140px; text-align: right;" class="text">จำนวนเงิน</th>
						</tr>
					</thead>
					<tbody>
		...
		<div class="buttom">
			<div class="buttom-l">
	    		...
	    		<div class="headL-r2">
	    			<input type="text" style ="width: 70%; background-color: #ffe6ff;" placeholder="รหัสพนักงาน" v-model="saleCode">
			...
			<div class="buttom-l">
	    		...
	    		<div class="headL-r2">
	    			<datepicker format="dd/MM/yyyy" style = "position: static;" input-class="input date" v-model="deliveryDate" required language="th" calendar-button-icon="fa fa-calendar" calendar-button :disabled="nowDate" :disabled-picker="disabled"></datepicker>
	    		</div>
	    		<div class="headL-l2">
	    			ครบกำหนด :
	    		</div>
		    	<div class="headL-r2">
	    			<datepicker format="dd/MM/yyyy" style = "position: static;" input-class="input date" v-model="dueDate" required language="th" calendar-button-icon="fa fa-calendar" calendar-button :disabled="nowDate" :disabled-picker="disabled"></datepicker>
		    	</div>
			</div>
			<div class="buttom-l">
				<div class="headL-l2">
			...
			<div class="buttom-l2">
	    		...
	    		<div class="headL-r">
	    			<input type="text" style="text-align:right;" readonly v-model = "totalNetAmount">
	    		</div>
			</div>
